...
image2 =Image.open('main_photo.jpg')
...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=230, height=400, bd=5, font=('times', 14, ' bold '),bg="honeydew4")
